...
describe('Service Tests', () => {
  describe('Formations Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(FormationsService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Formations(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should update a Formations', () => {
        const returnedFromService = Object.assign(
          {
            theme: 'BBBBBB',
            lebelleFormation: 'BBBBBB',
            coutFormation: 'BBBBBB',
            sourceFinancement: 'BBBBBB',
          },
          elemDefault
        );
