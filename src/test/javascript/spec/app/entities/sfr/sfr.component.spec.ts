...
import { SfrComponent } from 'app/entities/sfr/sfr.component';
import { SfrService } from 'app/entities/sfr/sfr.service';
import { Sfr } from 'app/shared/model/sfr.model';

describe('Component Tests', () => {
  describe('Sfr Management Component', () => {
    let comp: SfrComponent;
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sfrs && comp.sfrs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
