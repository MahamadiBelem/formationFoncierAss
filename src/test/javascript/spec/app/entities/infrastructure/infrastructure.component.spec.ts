...
import { InfrastructureComponent } from 'app/entities/infrastructure/infrastructure.component';
...
describe('Component Tests', () => {
  describe('Infrastructure Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.infrastructures && comp.infrastructures[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
