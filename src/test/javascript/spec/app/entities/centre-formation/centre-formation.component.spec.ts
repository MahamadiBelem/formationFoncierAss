...
import { CentreFormationComponent } from 'app/entities/centre-formation/centre-formation.component';
...
describe('Component Tests', () => {
  describe('CentreFormation Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.centreFormations && comp.centreFormations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
