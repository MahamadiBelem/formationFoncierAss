...
import { AmenagementComponent } from 'app/entities/amenagement/amenagement.component';
...
describe('Component Tests', () => {
  describe('Amenagement Management Component', () => {
    let comp: AmenagementComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AmenagementComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.amenagements && comp.amenagements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
