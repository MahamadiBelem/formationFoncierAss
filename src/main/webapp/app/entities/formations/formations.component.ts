...
export class FormationsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.formationsService
      ...
      .subscribe(
        (res: HttpResponse<IFormations[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFormations(): void {
    this.eventSubscriber = this.eventManager.subscribe('formationsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IFormations[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
