...
export class FormateursComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.formateursService
      ...
      .subscribe(
        (res: HttpResponse<IFormateurs[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInFormateurs(): void {
    this.eventSubscriber = this.eventManager.subscribe('formateursListModification', () => this.loadPage());
  }
