...
export class KitsComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.kitsService
      ...
      .subscribe(
        (res: HttpResponse<IKits[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInKits(): void {
    this.eventSubscriber = this.eventManager.subscribe('kitsListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IKits[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
