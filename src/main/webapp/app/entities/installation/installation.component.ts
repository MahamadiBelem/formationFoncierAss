...
export class InstallationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.installationService
      ...
      .subscribe(
        (res: HttpResponse<IInstallation[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInInstallations(): void {
    this.eventSubscriber = this.eventManager.subscribe('installationListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IInstallation[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
