...
public class FormateurCentreResource {
    ...
    public ResponseEntity<List<FormateurCentre>> getAllFormateurCentres(Pageable pageable) {
        log.debug("REST request to get a page of FormateurCentres");
        Page<FormateurCentre> page = formateurCentreService.findAll(pageable);
