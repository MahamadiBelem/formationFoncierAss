...
public class TypeInfratructureResource {
    ...
    public ResponseEntity<List<TypeInfratructure>> getAllTypeInfratructures(Pageable pageable) {
        log.debug("REST request to get a page of TypeInfratructures");
        Page<TypeInfratructure> page = typeInfratructureService.findAll(pageable);
