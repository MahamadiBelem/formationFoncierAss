...
public class FormationCentreFormationResource {
    ...
    public List<FormationCentreFormation> getAllFormationCentreFormations() {
        log.debug("REST request to get all FormationCentreFormations");
        return formationCentreFormationService.findAll();
    }
